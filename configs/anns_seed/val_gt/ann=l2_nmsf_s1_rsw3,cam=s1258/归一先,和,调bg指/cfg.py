...
# * 配置种子生成参数。
cfg.seed.ini.norm_first = Param2Tune([True])
cfg.seed.ini.gather_method = Param2Tune(['sum'])
cfg.seed.ini.bg_method = Param2Tune([{'method': 'pow', 'pow': .5},
                                     {'method': 'pow', 'pow': .6},
                                     {'method': 'pow', 'pow': .7},
                                     {'method': 'pow', 'pow': .8},
                                     {'method': 'pow', 'pow': .9},
                                     ...
                                     {'method': 'pow', 'pow': 2},
                                     {'method': 'pow', 'pow': 3}],
                                    optional_value_names=['p.5', 'p.6', 'p.7', 'p.8', 'p.9',
                                                          'p1', 'p2', 'p3'])
